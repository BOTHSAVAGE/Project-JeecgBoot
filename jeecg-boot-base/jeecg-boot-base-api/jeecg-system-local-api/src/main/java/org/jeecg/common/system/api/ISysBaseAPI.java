 ...
 * todo 4.14
 * 继承通用api，然后再重写
// *  * 发送系统消息 发送参数消息 发送模板消息 发送模板参数消息 推送 ID查询用户  用户查询角色 用户查询部门集合 部门名称查询部门  查询所有父级字典 查询分类字典 查询所有部门   已读消息 查询表字典  查询指定table字典 查询所有用户 分页查询用户 获取角色  部门相关 发消息 用户 权限相关
...
//    看了几遍人生的指南 我还是选择妹子太
// 目前最有趣的等待是未来
// 除了感动还有微风 我的世界明娜不多 自拍的拍排到室外 子啊拍的拍 拍到发嗲 前面杨过正面照郭艾伦i研究也不愿意睁开 和爱你的女号 看了几遍认识的指南 我还是溴铵在的妹子太  我选择的有趣的等待是未来 目前最有趣的的等待但是未来 目前最有趣的扽会给带的是  目前最有趣的扽会给带是维拉的
//研究也不愿意睁开 和爱你的那边v还的  和爱你的女孩